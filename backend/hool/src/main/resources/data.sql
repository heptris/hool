...
values (now(), now(), "SOCCER", "토트넘 아스날 축구경기", true, true, 1, "토트넘 vs 아스날", 4),
       (now(), now(), "SOCCER", "맨유 맨시티 축구경기입니다", true, true, 2, "맨시티 vs 맨유", 3),
       (now(), now(), 1234, "BASEBALL", "야구 경기~~~", true, 5, false, "야구 응원방", 6),
       (now(), now(), "abcd", "BASKETBALL", "농구 경기~~~", false, 1, false, "농구 응원방", 0);
--
